...
import { fetchEvent, fetchEventTicket } from "../../../../api/eventHandler";
      ...
      <section>
        <div className={style.container}>
          ...
          <PageCard
            ...
            backgroundUrl={eventDetail?.banner}
            pageName=""
          ...
          <>
            <div className={style.description}>
              {truncate(eventDetail?.description ?? "", 100, "...")}
            </div>
            <div className={style.resourceBox}>
              <SingleSelect onChange={(item) => toggleRegisterModal(item)}>
                ...
                <ResourceCard
                  ...
                  url={`/Event/Publish/join/${eventDetail?.id}`}
                />
