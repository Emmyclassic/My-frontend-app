...
const ResolutionForm = ({
  ...
  const onSubmit = (e) => {
    ...
    const payload = {
      ...
      allow_split_voting: resolution.allow_split_voting,
        ...
        <div className={style.settingList}>
          ...
          resolution.allow_physical ? (
            <SettingsCheckbox
              ...
              description="Only users added to the attendant list will be able to vote on resolution visible, users not on the list will be able to see the resolution bt won't be able to vote on the resolution."
