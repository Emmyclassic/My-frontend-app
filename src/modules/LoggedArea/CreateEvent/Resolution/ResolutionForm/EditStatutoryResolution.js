...
const EditStatutoryResolutionForms = ({
  openResolutionModal,
  action,
  handleStatutry,
  item,
  ...
  const onSubmit = (e) => {
    ...
    const payload = {
      ...
      allow_physical:
        resolution.allow_physical || resolution.allow_physical === 1 ? 1 : 0,
      attendees_only:
        resolution.attendees_only || resolution.attendees_only === 1 ? 1 : 0,
      ...
      <div className={style.settingWrapper}>
        <div className={style.settingList}>
          <SettingsCheckbox
            ...
            description="Only users added to the attendant list will be able to vote on resolution visible, users not on the list will be able to see the resolution but won't be able to vote on the resolution."
...
const Candidate = ({
  ...
  return (
    <div className={style.input_box}>
      ...
      <input
        className={`${style.form__input} ${style.form__input_candidate} `}
        type="text"
...
export default EditStatutoryResolutionForms;
